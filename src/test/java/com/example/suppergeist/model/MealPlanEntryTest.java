...
class MealPlanEntryTest {
    ...
    void fullConstructor_setsAllFields() {
        MealPlanEntry entry = new MealPlanEntry(10, 1, 2, 3, "dinner", null);
    ...
    void fullConstructor_acceptsNullId() {
        MealPlanEntry entry = new MealPlanEntry(null, 1, 2, 0, "breakfast", null);
        assertNull(entry.getId());
    }

    @Test
    void shortConstructor_setsNullId() {
        MealPlanEntry entry = new MealPlanEntry(1, 2, 0, "breakfast", null);
        assertNull(entry.getId());
    }

    @Test
    void shortConstructor_setsAllFields() {
        MealPlanEntry entry = new MealPlanEntry(5, 10, 6, "lunch", null);
